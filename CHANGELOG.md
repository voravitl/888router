...
- **Kimi K3:** Seed id `moonshotai/kimi-k3` from [GMI's Kimi K3 post](https://www.gmicloud.ai/en/blog/kimi-k3-open-weights-are-here-the-benchmark-phase-starts-now) (`model="moonshotai/kimi-k3"`). Also seeds DeepSeek V4 Pro, GPT 5.6 Sol, Claude Sonnet 5, Gemini 3.5 Flash Lite, GLM 5.2 FP8 from GMI developers + OpenClaw catalog.
