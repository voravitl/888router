...
function isBlockedIpv6Groups(g) {
  ...
  // 6to4 prefix 2002::/16 embeds IPv4 in hextets 1 and 2 (bits 16..47).
  if (g[0] === 0x2002) {
    const v4_6to4 = ((g[1] << 16) | g[2]) >>> 0;
    return isBlockedIpv4Int(v4_6to4);
  }
...
export function assertPublicUrl(rawUrl) {
  ...
  if (parsed.protocol !== "http:" && parsed.protocol !== "https:") {
    throw new Error("Blocked URL: non-http(s) protocol");
  }
