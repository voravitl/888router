...
export const MITM_TOOLS = {
  ...
  copilot: {
    ...
    modelAliases: ["gpt-6-astra", "gpt-5-mini", "gpt-5.4-nano", "claude-haiku-4.5", "gpt-4o", "gpt-4.1"],
    defaultModels: [
      ...
      { id: "gpt-6-astra", name: "GPT-6 Astra", alias: "gpt-6-astra" },
...
# cs45 -> cc/claude-sonnet-4-5-20250929`,
  ...
  jcode: {
    ...
    defaultModels: [
      ...
      { id: "gpt-6-astra", name: "GPT 6 Astra", alias: "gpt6", defaultValue: "cx/gpt-6-astra" },
