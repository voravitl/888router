...
**`resetsAtDisplayThresholdPercent: 0`** makes the reset time always render (OMC default is 85 — only shows when usage ≥ 85%). Set to e.g. `50` if you only want to see resets when usage passes half.
