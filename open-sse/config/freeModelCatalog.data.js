...
export const FREE_MODEL_BUDGETS = [
  ...
  { provider: "freebuff", modelId: "deepseek/deepseek-v4-pro", displayName: "DeepSeek V4 Pro (FreeBuff)", monthlyTokens: 0, creditTokens: 20000000, freeType: "recurring-daily", poolKey: "freebuff", tos: "caution" },
  { provider: "freebuff", modelId: "openai/gpt-5.6-luna", displayName: "GPT-5.6 Luna (FreeBuff)", monthlyTokens: 0, creditTokens: 20000000, freeType: "recurring-daily", poolKey: "freebuff", tos: "caution" },
  { provider: "freebuff", modelId: "minimax/minimax-m3", displayName: "MiniMax M3 (FreeBuff)", monthlyTokens: 0, creditTokens: 20000000, freeType: "recurring-daily", poolKey: "freebuff", tos: "caution" },
  { provider: "zenmux-free", modelId: "deepseek/deepseek-chat", displayName: "DeepSeek V3.2 Free", monthlyTokens: 0, creditTokens: 0, freeType: "recurring-uncapped", poolKey: "zenmux-free", tos: "caution" },
  { provider: "zenmux-free", modelId: "deepseek/deepseek-reasoner", displayName: "DeepSeek V3.2 Thinking Free", monthlyTokens: 0, creditTokens: 0, freeType: "recurring-uncapped", poolKey: "zenmux-free", tos: "caution" },
  { provider: "zenmux-free", modelId: "z-ai/glm-4.7-flash-free", displayName: "GLM 4.7 Flash Free", monthlyTokens: 0, creditTokens: 0, freeType: "recurring-uncapped", poolKey: "zenmux-free", tos: "caution" },
  { provider: "zenmux-free", modelId: "stepfun/step-3.5-flash-free", displayName: "Step 3.5 Flash Free", monthlyTokens: 0, creditTokens: 0, freeType: "recurring-uncapped", poolKey: "zenmux-free", tos: "caution" },
  ...
  { provider: "duckduckgo-web", modelId: "claude-3-haiku-20240307", displayName: "Claude 3 Haiku", monthlyTokens: 0, creditTokens: 0, freeType: "keyless", poolKey: "duckduckgo-web", tos: "avoid" },
  { provider: "duckduckgo-web", modelId: "meta-llama/Llama-3.3-70B-Instruct-Turbo", displayName: "Llama 3.3 70B Turbo", monthlyTokens: 0, creditTokens: 0, freeType: "keyless", poolKey: "duckduckgo-web", tos: "avoid" },
  { provider: "duckduckgo-web", modelId: "mistralai/Mistral-Small-24B-Instruct-2501", displayName: "Mistral Small 24B", monthlyTokens: 0, creditTokens: 0, freeType: "keyless", poolKey: "duckduckgo-web", tos: "avoid" },
  ...
  { provider: "kilo-gateway", modelId: "meituan/longcat-2.0-free", displayName: "Meituan LongCat 2.0 (free)", monthlyTokens: 0, creditTokens: 0, freeType: "recurring-uncapped", poolKey: "kilo-gateway-free", tos: "caution", trainsOnPrompts: true },
  { provider: "kilo-gateway", modelId: "poolside/laguna-s-2.1:free", displayName: "Poolside Laguna S 2.1 (free)", monthlyTokens: 0, creditTokens: 0, freeType: "recurring-uncapped", poolKey: "kilo-gateway-free", tos: "caution", trainsOnPrompts: true },
  { provider: "kilo-gateway", modelId: "inclusionai/ling-3.0-flash-fin:free", displayName: "InclusionAI Ling 3.0 Flash Fin (free)", monthlyTokens: 0, creditTokens: 0, freeType: "recurring-uncapped", poolKey: "kilo-gateway-free", tos: "caution", trainsOnPrompts: true },
  { provider: "kilo-gateway", modelId: "dots-studio/dots-3-note-preview:free", displayName: "Dots Studio Dots 3 Note (free)", monthlyTokens: 0, creditTokens: 0, freeType: "recurring-uncapped", poolKey: "kilo-gateway-free", tos: "caution", trainsOnPrompts: true },
  { provider: "kilo-gateway", modelId: "liquid/lfm-2.5-2.6b:free", displayName: "Liquid LFM 2.5 2.6B (free)", monthlyTokens: 0, creditTokens: 0, freeType: "recurring-uncapped", poolKey: "kilo-gateway-free", tos: "caution", trainsOnPrompts: true },
  { provider: "kilo-gateway", modelId: "nvidia/nemotron-3.5-lightning:free", displayName: "NVIDIA Nemotron 3.5 Lightning (free)", monthlyTokens: 0, creditTokens: 0, freeType: "recurring-uncapped", poolKey: "kilo-gateway-free", tos: "caution", trainsOnPrompts: true },
  { provider: "kilo-gateway", modelId: "thinkingmachines/inkling-small:free", displayName: "ThinkingMachines Inkling Small (free)", monthlyTokens: 0, creditTokens: 0, freeType: "recurring-uncapped", poolKey: "kilo-gateway-free", tos: "caution", trainsOnPrompts: true },
