...
export const AUTO_COMBO_TEMPLATES = [
  ...
  {
    name: "auto/best-free-1m",
    displayName: "Best Free 1M",
    categories: ["chat", "coding"],
    tiers: ["free"],
    strategy: "reset-aware",
    contextMin: 1000000,
    description: "Routes across free tier models with 1M+ context window (1,000,000 tokens)",
  },
  {
    name: "auto/cheap",
...
export const AUTO_TEMPLATE_VARIANTS = {
  ...
  "auto/best-free-1m": { category: "chat", tier: "free", contextMin: 1000000, strategy: "reset-aware" },
  "auto/free-1m": { category: "chat", tier: "free", contextMin: 1000000, strategy: "reset-aware" },
